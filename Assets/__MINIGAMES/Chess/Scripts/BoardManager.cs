        ...
        for (int i = 0; i < 8; i++)
        {
            for (int j = 7; j >= 0; j--)
            {
                ...
                else
                {
                    ...
                    if (chessman.GetType() == typeof(Rook))
                    {
                        if (chessman==WhiteRook1)
                            board[j, i] = 20;
                        if (chessman==WhiteRook2)
                            board[j, i] = 21;
                        if (chessman==BlackRook1)
                            board[j, i] = 26;
                        if (chessman==BlackRook2)
                            board[j, i] = 27;
                    }
                }
            }
